...
app.get('/', (reg, res) => {
    ...
    res.send("<br><h1>Saudações! </h1>" + 
            "<br><h2> Rota Raiz encontrada bla</h2>" +
...
app.get('/cidade_natal/turismo', (reg, res) => {
    console.log("Rota cidade_natal/turismo encontrada!")
    res.send("<br><h1>Saudações! </h1>" + 
            "<br><h2> Gruta dos Palhares </h2>" +
            "<br><h2>  Cachoeiras do César e do Azulinho </h2>")
})
